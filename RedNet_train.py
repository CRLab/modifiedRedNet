...
from utils.utils import StratifiedSampler
...
parser.add_argument('--print-freq', '-p', default=200, type=int,
                    metavar='N', help='print batch frequency (default: 200)')
...
image_h = 480
def train():
    train_data = RedNet_data.GibsonDataset(transform=transforms.Compose([RedNet_data.scaleNorm(),
    ...
    train_loader = DataLoader(train_data, batch_size=args.batch_size, shuffle=True, #sampler=StratifiedSampler(train_data, utils.def_weights, args.batch_size),
